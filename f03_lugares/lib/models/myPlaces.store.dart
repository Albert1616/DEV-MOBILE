...
part "myPlaces.store.g.dart";

class MyPlacesModelX = _MyPlacesModelX with _$MyPlacesModelX;

abstract class _MyPlacesModelX with Store {
  @observable
  ObservableList<Place> places = ObservableList<Place>.of([
    Place(
      id: 'p1',
      titulo: 'Praia',
      paises: ['c8', 'c5', 'c9'],
