...
class _PlaceDetailScreenState extends State<PlaceDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final favoritesModelX = Provider.of<FavoritesModelX>(context);

    _Favorites(Place place) {
      setState(() {
        if (favoritesModelX.searchPlace(place.id)) {
          favoritesModelX.remove(place);
        } else {
          favoritesModelX.add(place);
        }
      });
    }
      ...
      body: Center(
        ...
        floatingActionButton: Observer(
          builder: (context) => FloatingActionButton(
            ...
            child: Icon(favoritesModelX.searchPlace(place.id)
                ? Icons.star
                : Icons.star_border),
          ),
        ));
