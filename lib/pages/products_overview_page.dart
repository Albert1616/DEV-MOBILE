  ...
  Widget build(BuildContext context) {
    ...
    _login(String email, String password) async{
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          ...
          SnackBar(content: 
          Text("Não foi encontrada nenhuma conta com esses dados"),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ElevatedButton(
                        onPressed: (){_login(_email.text, _password.text);},
                        child: Text("Entrar")),
                      TextButton(
                        onPressed: (){Navigator.pushNamed(context, '/user-form');}, 
                        child: Text("Ainda naõ tem conta? Cadastre-se!", style: TextStyle(fontSize: 10),))
                    ],
                  )
                ],
              ),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          userModelX.isLogin? PopupMenuButton(
            child: Padding(
            ...
            onPressed: (){_showDialogLogin(context);}, 
